...
- 🏆 **Achievements** — **40** unlockable trophies across all focuses: celebratory (`Killing Spree`,
  `Dragon Slayer`, `Legend`, `Marathon`, `Night Owl`…) and self-deprecating (`Star Magnet` — catch 5
  shooting stars in one week, RIP 💀). Plus **3 secret** ones. Trophy icon.
...
There are **6 hidden easter eggs**. Go find them — one is older than you'd think, one is fully
playable, and one will make you feel like Neo.
...
- Type `party`.
- Type `pong` — the LED panel grows into a playable **Pong** (mouse / ↑↓, first to 5). Beat the CPU for a secret trophy.
- Type `matrix` — digital rain. 🐇 Follow the white rabbit.
